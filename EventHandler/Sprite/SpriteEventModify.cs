...
namespace EventHandler.Sprite {
    ...
    public class SpriteEventModify {
        ...
        public SpriteEventModify SetTimeRange(float toBegin, float toEnd,
            float fromBegin, float fromEnd) { return WithModifiers(new EventSetTimeRange(toBegin, toEnd, fromBegin, fromEnd)); }
        public SpriteEventModify SetTimeRange(float toBegin, float toEnd) { return WithModifiers(new EventSetTimeRange(toBegin, toEnd, 
